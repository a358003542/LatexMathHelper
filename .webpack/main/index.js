...
const {
  DEBUG
} = __webpack_require__(/*! ./const */ "./app/latexMathHelper/const.js");
...
if (__webpack_require__(/*! electron-squirrel-startup */ "./node_modules/electron-squirrel-startup/index.js")) app.quit();
const path = __webpack_require__(/*! path */ "path");
const {
  DEBUG
} = __webpack_require__(/*! ./latexMathHelper/const */ "./app/latexMathHelper/const.js");
const {
  menu_template
} = __webpack_require__(/*! ./latexMathHelper/menu */ "./app/latexMathHelper/menu.js");
function createWindow() {
  ...
  const mainWindow = new BrowserWindow({
    ...
    height: 600,
    webPreferences: {
      preload: 'D:\\project\\LatexMathHelper\\.webpack\\renderer\\main_window\\preload.js'
    }
  });
  if (DEBUG) {
    mainWindow.maximize();
